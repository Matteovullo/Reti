...
VBoxManage.exe clonevm debbie2023 --snapshot Snapshot --name R2 --options link --register
...
VBoxManage.exe clonevm debbie2023 --snapshot Snapshot --name R3 --options link --register
...
VBoxManage.exe clonevm debbie2023 --snapshot Snapshot --name R4 --options link --register
